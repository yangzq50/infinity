...
module ivf_product_quantization;
import stl;
...
UniquePtr<IVFProductQuantizer> GetIVFOPQT_Helper(const u32 pq_subspace_num, const u32 subspace_dimension) {
...
UniquePtr<IVFProductQuantizer> GetIVFOPQT_Helper(const u32 pq_subspace_num, const u32 subspace_dimension) {
    ...
    return GetIVFOPQT_Helper<T, J...>(pq_subspace_num, subspace_dimension);
}

template <std::unsigned_integral T>
UniquePtr<IVFProductQuantizer> GetIVFOPQT(const u32 pq_subspace_num, const u32 subspace_dimension) {
    return GetIVFOPQT_Helper<T, 1, 2, 4, 8, 16, 32, 64, 128>(pq_subspace_num, subspace_dimension);
}

UniquePtr<IVFProductQuantizer> GetIVFOPQ(const u32 pq_subspace_num, const u32 pq_subspace_bits, const u32 embedding_dimension) {
    ...
    if (pq_subspace_bits == 8) {
        return GetIVFOPQT<u8>(pq_subspace_num, subspace_dimension);
    }
    if (pq_subspace_bits == 16) {
        return GetIVFOPQT<u16>(pq_subspace_num, subspace_dimension);
    }
    {
