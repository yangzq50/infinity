...
export module ivf_product_quantization;
import stl;

namespace infinity {
class LocalFileHandle;

export class IVFProductQuantizer {
public:
    virtual ~IVFProductQuantizer() = default;
...
class PQ : public IVFProductQuantizer {
protected:
...
export UniquePtr<IVFProductQuantizer> GetIVFOPQ(u32 pq_subspace_num, u32 pq_subspace_bits, u32 embedding_dimension);
